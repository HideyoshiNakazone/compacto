...
class TestInternalTypes:
    ...
    def test_get_from_type_with_ctype(self) -> None:
        ...
        assert (
            InternalTypes.get_from_type(int, ctype=ctypes.c_int8) == InternalTypes.INT_8
        )
        assert (
    ...
    def test_get_from_type_with_custom_types(self) -> None:
        ...
        assert InternalTypes.get_from_type(Optional) == InternalTypes.OPTIONAL
        assert InternalTypes.get_from_type(InternalTestClass) == InternalTypes.OBJECT
    ...
    def test_custom_type(self) -> None:
        ...
        assert InternalTypes.OPTIONAL.value.get_python_type() is Optional
