...
class TestFieldEncoder:
    ...
    def test_encode_decode_positive_float(self, typing_tree: TreeNode[FieldsDeff]):
        data = FieldEncoder.encode(typing_tree, 3.14)
        decoded_value, offset = FieldEncoder.decode(typing_tree, data)
